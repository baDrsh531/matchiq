...
Sert sur http://localhost:5173, consomme l'API sur http://localhost:8000.
...
Les réponses API-Football sont cachées dans `data/raw/`, les rapports LLM dans `data/processed/` — aucun appel n'est répété une fois caché.
